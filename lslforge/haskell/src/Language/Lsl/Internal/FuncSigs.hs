...
funcSigs = [
    --Avatar
    ("osAgentSaveAppearance",LLKey,[LLKey,LLString]),
    ("osAvatarName2Key",LLString,[LLString,LLString]),
    ("osAvatarPlayAnimation",LLVoid,[LLKey,LLString]),
    ("osAvatarStopAnimation",LLVoid,[LLKey,LLString]),
    ("osCauseDamage",LLVoid,[LLKey,LLFloat]),
    ("osCauseHealing",LLVoid,[LLKey,LLFloat]),
    ("osDropAttachment",LLVoid,[]),
    ("osDropAttachmentAt",LLVoid,[LLVector,LLRot]),
    ("osEjectFromGroup",LLInteger,[LLKey]),
    ("osForceAttachToAvatar",LLVoid,[LLInteger]),
    ("osForceAttachToAvatarFromInventory",LLVoid,[LLString,LLInteger]),
    ("osForceAttachToOtherAvatarFromInventory",LLVoid,[LLString,LLString,LLInteger]),
    ("osForceDetachFromAvatar",LLVoid,[]),
    ("osForceDropAttachment",LLVoid,[]),
    ("osForceDropAttachmentAt",LLVoid,[LLVector,LLRot]),
    ("osForceOtherSit",LLVoid,[LLString]),
    ("osForceOtherSit",LLVoid,[LLString,LLString]),
    ("osGetAgentIP",LLString,[LLKey]),
    ("osGetAgents",LLList,[LLVoid]),
    ("osGetAvatarHomeURI",LLString,[LLString]),
    ("osGetAvatarList",LLList,[LLVoid]),
    ("osGetGender",LLString,[LLKey]),
    ("osGetHealth",LLFloat,[LLString]),
    ("osGetNumberOfAttachments",LLList,[LLKey,LLList]),
    ("osInviteToGroup",LLInteger,[LLKey]),
    ("osKickAvatar",LLVoid,[LLString,LLString,LLString]),
    ("osOwnerSaveAppearance",LLKey,[LLString]),
    ("osSetHealth",LLFloat,[LLString,LLFloat]),
    ("osSetSpeed",LLVoid,[LLString,LLFloat]),
    ...
    ("osTeleportOwner",LLVoid,[LLInteger,LLInteger,LLVector,LLVector]),
    ("osTeleportOwner",LLVoid,[LLString,LLVector,LLVector]),
    ("osTeleportOwner",LLVoid,[LLVector,LLVector]),
    --NPC
    ("osIsNpc",LLInteger,[LLKey]), 
    ("osNpcCreate",LLKey,[LLString,LLString,LLVector,LLString]),
    ("osNpcCreate",LLKey,[LLString,LLString,LLVector,LLString,LLInteger]),
    ("osNpcGetPos",LLVector,[LLKey]),
    ("osNpcGetRot",LLRot,[LLKey]),
    ("osNpcGetOwner",LLKey,[LLKey]),
    ("osNpcLoadAppearance",LLVoid,[LLKey,LLString]),
    ("osNpcMoveTo",LLVoid,[LLKey,LLVector]),
    ("osNpcMoveToTarget",LLVoid,[LLKey,LLVector,LLInteger]),
    ("osNpcPlayAnimation",LLVoid,[LLKey,LLString]),
    ("osNpcRemove",LLVoid,[LLKey]),
    ("osNpcSaveAppearance",LLKey,[LLKey,LLString]),
    ("osNpcSay",LLVoid,[LLKey,LLString]),
    ("osNpcSay",LLVoid,[LLKey,LLInteger,LLString]),
    ("osNpcSetRot",LLVoid,[LLKey,LLRot]),
    ("osNpcShout",LLVoid,[LLKey,LLInteger,LLString]),
    ("osNpcSit",LLVoid,[LLKey,LLKey,LLInteger]),
    ("osNpcStand",LLVoid,[LLKey]),
    ("osNpcStopAnimation",LLVoid,[LLKey,LLString]),
...
funcDescriptions = [
    ("osAgentSaveAppearance",(["agentId","notecard"],"Save an arbitrary avatar's appearance to a notecard in the prim's inventory\n")),
    ("osAvatarName2Key",(["FirstName","LastName"],"Returns an avatar's UUID, based on his/her first and last name\n")),
    ("osAvatarPlayAnimation",(["avatar","animation"],"Causes an animation to be played on the specified avatar\n")),
    ("osAvatarStopAnimation",(["avatar","animation"],"Stops the specified animation if it is playing on the avatar given\n")),
    ("osCauseDamage",(["avatar","damage"],"Allows for damage on collision, touch, etc\n")),
    ("osCauseHealing",(["avatar","healing"],"Gives health to the avatar\n")),
    ("osDropAttachment",([],"Drops an attachment like a user-triggered attachment drop\n")),
    ("osDropAttachmentAt",(["pos","rot"],"Drops an attachment at position pos with rotation rot\n")),
    ("osEjectFromGroup",(["user"],"Eject the given user from the group the object is set to\n")),
    ("osForceAttachToAvatar",(["attachmentPoint"],"Exactly like llAttachToAvatar() except that PERMISSION_ATTACH is not required\n")),
    ("osForceAttachToAvatarFromInventory",(["itemName","attachmentPoint"],"Attach an inventory item in the object containing this script to any avatar in the region without asking for PERMISSION_ATTACH\n")),
    ("osForceAttachToOtherAvatarFromInventory",(["rawAvatarId","itemName","attachmentPoint"],"Attach an inventory item in the object containing this script to any avatar in the region without asking for PERMISSION_ATTACH\n")),
    ("osForceDetachFromAvatar",([],"Exactly like llDetachFromAvatar() except that PERMISSION_ATTACH is not required\n")),
    ("osForceDropAttachment",([],"Drops an attachment like a user-triggered attachment drop without checking PERMISSION_ATTACH\n")),
    ("osForceDropAttachmentAt",(["pos","rot"],"Drops an attachment at position pos with rotation rot without checking PERMISSION_ATTACH\n")),
    ("osForceOtherSit",(["avatar"],"Forces a sit of targeted avatar\n")),
    ("osForceOtherSit",(["avatar","target"],"Forces a sit of targeted avatar onto prim\n")),
    ("osGetAgentIP",(["uuid"],"Returns a string representing the IP address returned\n")),
    ("osGetAgents",([],"Returns a list of all the agents names in the region\n")),
    ("osGetAvatarHomeURI",(["uuid"],"Returns an avatar's Home URI\n")),
    ("osGetAvatarList",([],"Returns a strided list of the UUID, position, and name of each avatar in the region except the ownen\n")),
    ("osGetGender",(["id"],"Returns a string with one of the following values: male, female, unknown\n")),
    ("osGetHealth",(["avatar"],"Gets an avatars health by key\n")),
    ("osGetNumberOfAttachments",(["avatar","attachmentPoints"],"Returns a strided list of the specified attachment points and the number of attachments on those points\n")),
    ("osInviteToGroup",(["user"],"Invite the given user to the group the object is set to\n")),
    ("osKickAvatar",(["FirstName","SurName","alert"],"This is the same thing as the console command\n")),
    ("osOwnerSaveAppearance",(["notecard"],"Save the owner's current appearance to a notecard in the prim's inventory\n")),
    ("osSetHealth",(["avatar","health"],"Sets an avatars health by key to the specified float value\n")),
    ("osSetSpeed",(["UUID","SpeedModifier"],"Multiplies the running, walking, rotating and flying of the avatar\n")),
    ("osTeleportAgent",(["agent","regionX","regionY","position","lookat"],"Teleports an agent to the specified location\n")),
    ("osTeleportAgent",(["agent","regionName","position","lookat"],"Teleports an agent to the specified location\n")),
    ("osTeleportAgent",(["agent","position","lookat"],"Teleports an agent to the specified location\n")),
    ("osTeleportOwner",(["regionX","regionY","position","lookat"],"Teleports the owner of the object containing the script to the specified location\n")),
    ("osTeleportOwner",(["regionName","position","lookat"],"Teleports the owner of the object containing the script to the specified location\n")),
    ("osTeleportOwner",(["position","lookat"],"Teleports the owner of the object containing the script to the specified location\n")),
    --
    ...
    ("osNpcStopAnimation",(["npc","animation"],"Stops animation on being played by the NPC identified by their key\n")),
